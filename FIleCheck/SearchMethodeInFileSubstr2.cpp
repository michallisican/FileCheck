...
void SearchMethodeInFileSubstr2::SearchMethodeInFile(std::string file_name, std::string key)
{
	std::ifstream file;
...
std::vector<LineFilePrefix> SearchMethodeInFileSubstr2::GetResults()
{
